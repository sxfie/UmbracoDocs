...
:::note
There is a different version of this article for Umbraco V8 - the common pitfalls and anti-patterns are slightly different for each version of Umbraco. The architecture of V8 has been designed to mitigate some of these pitfalls.
:::
